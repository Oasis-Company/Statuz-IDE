...
class AgentManagementViewPane extends ViewPane {
	...
	protected override renderBody(parent: HTMLElement): void {
		...
		icon.classList.add('codicon', 'codicon-symbol-method');
		...
		desc.textContent = 'Skill registry, harness engineering visualization & configuration management — coming soon.';
