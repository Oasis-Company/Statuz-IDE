...
class BoardViewPane extends ViewPane {
	...
	protected override renderBody(parent: HTMLElement): void {
		...
		icon.classList.add('codicon', 'codicon-project');

		const title = document.createElement('h2');
		title.textContent = 'Sandboxer Board';
		title.style.cssText = 'font-size:18px;font-weight:600;color:var(--vscode-foreground);margin:0 0 8px;';

		const desc = document.createElement('p');
		desc.textContent = 'Strategy canvas, project workspace & AI-ready blueprint — coming soon.';
