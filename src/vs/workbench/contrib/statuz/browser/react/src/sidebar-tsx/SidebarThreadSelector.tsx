...
export const PastThreadsList = ({ className = '' }: { className?: string }) => {
	...
	return (
		<div className={`flex flex-col mb-2 gap-2 w-full text-nowrap text-statuz-fg-3 select-none relative ${className}`}>
			...
			{hasMoreThreads && !showAll && (
				<div
					className="text-statuz-fg-3 opacity-80 hover:opacity-100 hover:brightness-115 cursor-pointer p-1 text-xs"
