...
export const VoidTooltip = () => {
	...
	return (
		...
		// --statuz-bg-1: var(--vscode-input-background);
		// --statuz-bg-1-alt: var(--vscode-badge-background);
		// --statuz-bg-2: var(--vscode-sideBar-background);
		// --statuz-bg-2-alt: color-mix(in srgb, var(--vscode-sideBar-background) 30%, var(--vscode-editor-background) 70%);
		// --statuz-bg-3: var(--vscode-editor-background);

		// --statuz-fg-0: color-mix(in srgb, var(--vscode-tab-activeForeground) 90%, black 10%);
		// --statuz-fg-1: var(--vscode-editor-foreground);
		// --statuz-fg-2: var(--vscode-input-foreground);
		// --statuz-fg-3: var(--vscode-input-placeholderForeground);
		// /* --statuz-fg-4: var(--vscode-tab-inactiveForeground); */
		// --statuz-fg-4: var(--vscode-list-deemphasizedForeground);

		// --statuz-warning: var(--vscode-charts-yellow);

		// --statuz-border-1: var(--vscode-commandCenter-activeBorder);
		// --statuz-border-2: var(--vscode-commandCenter-border);
		// --statuz-border-3: var(--vscode-commandCenter-inactiveBorder);
		// --statuz-border-4: var(--vscode-editorGroup-border);
