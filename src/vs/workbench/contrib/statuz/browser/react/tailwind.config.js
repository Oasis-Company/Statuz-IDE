	...
	theme: {
		extend: {
			typography: theme => ({
				DEFAULT: {
					css: {
						'--tw-prose-body': 'var(--statuz-fg-1)',
						'--tw-prose-headings': 'var(--statuz-fg-1)',
						'--tw-prose-lead': 'var(--statuz-fg-2)',
						'--tw-prose-links': 'var(--statuz-link-color)',
						'--tw-prose-bold': 'var(--statuz-fg-1)',
						'--tw-prose-counters': 'var(--statuz-fg-3)',
						'--tw-prose-bullets': 'var(--statuz-fg-3)',
						'--tw-prose-hr': 'var(--statuz-border-4)',
						'--tw-prose-quotes': 'var(--statuz-fg-1)',
						'--tw-prose-quote-borders': 'var(--statuz-border-2)',
						'--tw-prose-captions': 'var(--statuz-fg-3)',
						'--tw-prose-code': 'var(--statuz-fg-0)',
						'--tw-prose-pre-code': 'var(--statuz-fg-0)',
						'--tw-prose-pre-bg': 'var(--statuz-bg-1)',
						'--tw-prose-th-borders': 'var(--statuz-border-4)',
						'--tw-prose-td-borders': 'var(--statuz-border-4)',
					},
				},
			}),
			fontSize: {
			...
			colors: {
				'statuz-bg-1': 'var(--statuz-bg-1)',
				'statuz-bg-1-alt': 'var(--statuz-bg-1-alt)',
				'statuz-bg-2': 'var(--statuz-bg-2)',
				'statuz-bg-2-alt': 'var(--statuz-bg-2-alt)',
				'statuz-bg-2-hover': 'var(--statuz-bg-2-hover)',
				'statuz-bg-3': 'var(--statuz-bg-3)',


				'statuz-fg-0': 'var(--statuz-fg-0)',
				'statuz-fg-1': 'var(--statuz-fg-1)',
				'statuz-fg-2': 'var(--statuz-fg-2)',
				'statuz-fg-3': 'var(--statuz-fg-3)',
				// 'statuz-fg-4': 'var(--vscode-tab-inactiveForeground)',
				'statuz-fg-4': 'var(--statuz-fg-4)',

				'statuz-warning': 'var(--statuz-warning)',

				'statuz-border-1': 'var(--statuz-border-1)',
				'statuz-border-2': 'var(--statuz-border-2)',
				'statuz-border-3': 'var(--statuz-border-3)',
				'statuz-border-4': 'var(--statuz-border-4)',

				'statuz-ring-color': 'var(--statuz-ring-color)',
				'statuz-link-color': 'var(--statuz-link-color)',
