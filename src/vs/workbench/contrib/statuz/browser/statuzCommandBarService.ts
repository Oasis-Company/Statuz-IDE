...
import { mountStatuzCommandBar } from './react/out/statuz-editor-widgets-tsx/index.js'
...
import { STATUZ_ACCEPT_DIFF_ACTION_ID, STATUZ_REJECT_DIFF_ACTION_ID, STATUZ_GOTO_NEXT_DIFF_ACTION_ID, STATUZ_GOTO_PREV_DIFF_ACTION_ID, STATUZ_GOTO_NEXT_URI_ACTION_ID, STATUZ_GOTO_PREV_URI_ACTION_ID, STATUZ_ACCEPT_FILE_ACTION_ID, STATUZ_REJECT_FILE_ACTION_ID, STATUZ_ACCEPT_ALL_DIFFS_ACTION_ID, STATUZ_REJECT_ALL_DIFFS_ACTION_ID } from './actionIDs.js';
...
export interface IStatuzCommandBarService {
...
export const IStatuzCommandBarService = createDecorator<IStatuzCommandBarService>('StatuzCommandBarService');
...
export class StatuzCommandBarService extends Disposable implements IStatuzCommandBarService {
	_serviceBrand: undefined;

	static readonly ID: 'void.StatuzCommandBarService'
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: STATUZ_ACCEPT_DIFF_ACTION_ID,
			f1: true,
			title: localize2('statuzAcceptDiffAction', 'Statuz: Accept Diff'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: STATUZ_REJECT_DIFF_ACTION_ID,
			f1: true,
			title: localize2('statuzRejectDiffAction', 'Statuz: Reject Diff'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: STATUZ_GOTO_NEXT_DIFF_ACTION_ID,
			f1: true,
			title: localize2('statuzGoToNextDiffAction', 'Statuz: Go to Next Diff'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: STATUZ_GOTO_PREV_DIFF_ACTION_ID,
			f1: true,
			title: localize2('statuzGoToPrevDiffAction', 'Statuz: Go to Previous Diff'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: STATUZ_GOTO_NEXT_URI_ACTION_ID,
			f1: true,
			title: localize2('statuzGoToNextUriAction', 'Statuz: Go to Next File with Diffs'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: STATUZ_GOTO_PREV_URI_ACTION_ID,
			f1: true,
			title: localize2('statuzGoToPrevUriAction', 'Statuz: Go to Previous File with Diffs'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: STATUZ_ACCEPT_FILE_ACTION_ID,
			f1: true,
			title: localize2('statuzAcceptFileAction', 'Statuz: Accept All Diffs in Current File'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: STATUZ_REJECT_FILE_ACTION_ID,
			f1: true,
			title: localize2('statuzRejectFileAction', 'Statuz: Reject All Diffs in Current File'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: STATUZ_ACCEPT_ALL_DIFFS_ACTION_ID,
			f1: true,
			title: localize2('statuzAcceptAllDiffsAction', 'Statuz: Accept All Diffs in All Files'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: STATUZ_REJECT_ALL_DIFFS_ACTION_ID,
			f1: true,
			title: localize2('statuzRejectAllDiffsAction', 'Statuz: Reject All Diffs in All Files'),
			keybinding: {
