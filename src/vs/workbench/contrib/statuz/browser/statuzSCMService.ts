...
class GenerateCommitMessageAction extends Action2 {
	constructor() {
		super({
			...
			title: localize2('statuzCommitMessagePrompt', 'Statuz: Generate Commit Message'),
			icon: ThemeIcon.fromId('sparkle'),
			tooltip: localize2('statuzCommitMessagePromptTooltip', 'Statuz: Generate Commit Message'),
			f1: true,
			menu: [{
...
class LoadingGenerateCommitMessageAction extends Action2 {
	constructor() {
		super({
			...
			title: localize2('statuzCommitMessagePromptCancel', 'Statuz: Cancel Commit Message Generation'),
			icon: ThemeIcon.fromId('stop-circle'),
			tooltip: localize2('statuzCommitMessagePromptCancelTooltip', 'Statuz: Cancel Commit Message Generation'),
