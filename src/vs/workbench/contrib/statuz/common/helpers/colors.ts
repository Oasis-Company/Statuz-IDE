...
// gets converted to --vscode-void-greenBG, see statuz.css, asCssVariable
registerColor('statuz.greenBG', configOfBG(acceptBG), '', true);
registerColor('statuz.redBG', configOfBG(rejectBG), '', true);
registerColor('statuz.sweepBG', configOfBG(sweepBG), '', true);
registerColor('statuz.highlightBG', configOfBG(highlightBG), '', true);
registerColor('statuz.sweepIdxBG', configOfBG(sweepIdxBG), '', true);
